...
//     const a = S2Util.getBoundingLatLngRectFromQueryRadiusInput({
//       RadiusInMeter: 10,
//       CenterPoint: new S2.LatLng(59, 0),
//     });
//     const b = S2.RegionCoverer.getCoveringIds(a, {});
//     if (a && b) {
//       const cov = new Covering(b);
...
//       S2.RegionCoverer.getCoveringIds(
